    ...
    @media (max-width: 768px) {
      ...
      <main className="container">
        <div className="flex items-center mb-4">
          ...
          <h1 className="ml-4">Resep Salad Sayur</h1>
        </div>
          ...
          <div className="recipe-container">
            ...
            <div className="instructions">
              ...
              <ol>
                ...
                <li>Campurkan bahan dressing: minyak zaitun, cuka, mustard, madu, garam, lada, dan lemon, aduk rata.</li>
                <li>Campurkan semua sayuran dalam mangkuk besar, tuang dressing, dan aduk rata.</li>
                <li>Sajikan dengan hiasan daun ketumbar atau peterseli (opsional).</li>
              </ol>
            </div>
