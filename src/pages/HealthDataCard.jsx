    ...
    return (
      <div className="bg-gray-50 rounded-lg p-6">
        ...
        <div className="mt-8 p-6 bg-[#0E6245] text-white rounded-lg">
          <p className="mb-4">
            Ternyata berat badan kamu belum mencapai kondisi ideal nih :( 
            kamu bisa check ke rekomendasi resep menu makanan untuk mulai menjaga kalori atau diet kalori yaa!
          </p>
          <p>
